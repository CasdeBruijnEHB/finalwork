  ...
  return (
    <group onClick={() => onClick('genre_shoes')} name='genre_shoes' {...props} dispose={null} position={[42, -17.5, 4]} rotation={[0, 2, 0]} scale={2.6}>
        ...
        <group  position={[-0.6, 1.28, -0.15]} rotation={[Math.PI / 2, 0, 3.01]} scale={0.15}>
          ...
          <mesh ref={mesh1} geometry={nodes.Shoe_L.geometry} material={colorData[5]}>
            </mesh>
        ...
        <group  position={[0.19, -0.39, 0.11]} rotation={[Math.PI / 2, 0, -0.1]} scale={0.15}>
          <mesh geometry={nodes.Laces_R.geometry} material={colorData[1]} position={[4.98, 0, -11.19]} rotation={[0, 0, -0.15]} />
          <mesh geometry={nodes.Shoe_R.geometry} material={colorData[5]} position={[4.98, 0, -11.19]} rotation={[0, 0, -0.15]} />
          <mesh geometry={nodes.Sole_R.geometry} material={colorData[0]} position={[4.98, 0, -11.19]} rotation={[0, 0, -0.15]} />
        </group >
        <mesh geometry={nodes.BoxBottom.geometry} material={colorData[3]} position={[0.18, -0.39, 0.02]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.14} />
        <mesh geometry={nodes.BoxTop.geometry} material={colorData[2]} position={[0.18, -0.39, 0.02]} rotation={[Math.PI / 2, 0, 1.57]} scale={0.14} />
